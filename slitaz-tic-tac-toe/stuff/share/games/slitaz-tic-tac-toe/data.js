var x = "black-stone.png";

var o = "white-stone.png";
...
function restart() {
  if (confirm('Delete all score and restart game?')) {
    window.location="slitaz-tic-tac-toe.html" 
}
}
function ended() {
alert("Ops! This round is over. \n\n To play again click 'New Round' button. \n\n To restart all game click 'Restart' button.")
}
function process() {
logicOne();
if (all==1){ alert("Woohoooo! \n\n You are amazing " + player + "! \n\n I'm not buying it. \n\n New round? \n\n"); wn++;}
if (all==2){ alert("Awww, that's too bad! \n\n Try to win me! \n\n"); ls++;}
if (all==3){ alert("Tie! Let's play again?"); ts++;}
if (all!=0) {
document.game.you.value = wn; 
document.game.slitaz.value = ls;
document.game.ties.value = ts;
   } 
}
function playAgain() {
if (all==0) {
if(confirm("Start new round?")) reset();
}
if (all>0) reset();
}
function reset() {
