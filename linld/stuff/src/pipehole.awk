...
function isnum(n) { return match(n,/^[0-9+-]/) }
{
	...
	if (isload == 1) {  # LOAD.LST
	 ...
	 if (file == "iso9660.cpp") {
	if (/ptr \[si\+10\],dx/) next
	if (/ptr \[si\+8\],ax/) next
	if (/si\+32/) next
	if (/add	word ptr \[si\],ax/) $0="	add	word ptr [si],cx"
	...
	if (/found:/) isiso=15
	if (/short @1@394/) sub(/@1@394/,"@1@422")
